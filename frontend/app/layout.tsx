...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Bot de WhatsApp, PDV e controle de estoque numa só plataforma. 14 dias grátis.',
    images: [
      {
        url: '/og-image.png',
        width: 1200,
  ...
  twitter: {
    ...
    title: 'GTSoftHub | Vender em qualquer canal, como se fosse tudo um só',
    description: 'Bot de WhatsApp, PDV e controle de estoque numa só plataforma.',
    images: ['/og-image.png'],
    creator: '@gtsofthub',
  },
