      ...
      <div className="relative overflow-hidden">
        ...
        <section className="page-wrap mt-8 grid gap-10 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="space-y-6">
            <h2 className="text-3xl font-semibold text-white">Tres interfaces, um unico pulso.</h2>
            <p className="text-slate-200">
              PDV, e-commerce e WhatsApp obedecem o mesmo core. Um painel unico, estoque central e dados instantaneos.
            </p>
