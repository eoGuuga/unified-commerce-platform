...
import { ArrowUpRight, Package, AlertTriangle, TrendingUp } from 'lucide-react';
import Link from 'next/link';

/** Página de estoque. A casca (AdminShell) fornece o layout e a nav. */
      ...
      <div className="mx-auto max-w-3xl text-center">
        ...
        <div className="mt-12 grid grid-cols-1 gap-px bg-[#1a1814]/8 sm:grid-cols-3">
          {[
            ...
            { i: AlertTriangle, v: '0', l: 'Em atenção' },
            { i: TrendingUp, v: '0', l: 'Reposições hoje' },
          ].map((m) => (
            <div key={m.l} className="bg-[#f6f3ee] p-6 text-left">
              ...
              <p
                className="mt-3 text-[36px] font-normal leading-none tracking-[-0.03em]"
                style={{ fontFamily: 'var(--font-display)' }}
              >
                {m.v}
              </p>
