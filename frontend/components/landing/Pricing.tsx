...
const plans = [
  {
    ...
    popular: false,
    underTheHood: {
      transactions: "500/m�s",
      lockType: "Optimistic",
      channels: "2 canais",
      syncLatency: "<200ms (alvo)",
      guarantee: "Suporte b�sico",
    },
  },
  {
    name: "Crescimento",
    ...
    popular: false,
    underTheHood: {
      transactions: "2.000/m�s",
      lockType: "Pessimistic",
      channels: "4 canais",
      syncLatency: "<150ms (alvo)",
      guarantee: "Suporte priorit�rio",
    },
  },
  {
    name: "Escala",
          ...
          <div className="relative flex-1 flex flex-col">
            ...
            <div className="mb-6">
              ...
              <p className={`text-xs ${plan.popular ? "opacity-50" : "text-muted-foreground"}`}>
                Especifica��es t�cnicas do plano {plan.name}
              </p>
            </div>
            ...
            <div className="flex-1 space-y-4">
              {[
                { label: "Transa��es", value: plan.underTheHood.transactions, icon: "M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" },
      ...
      <Container className="relative">
        <div className="max-w-3xl mx-auto text-center section-header-gap">
          ...
          <p className="text-xs text-muted-foreground/60">
            Clique em qualquer card para ver as especifica��es t�cnicas
          </p>
        </div>
        ...
        <div className="mt-10 lg:mt-12 xl:mt-14 flex flex-wrap items-center justify-center gap-6 lg:gap-8 text-sm text-muted-foreground">
          {[
            { icon: "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z", text: "14 dias gr�tis" },
            { icon: "M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z", text: "Sem cart�o de cr�dito" },
