...
const problems = [
  ...
  },
  {
    ...
    description: "Sistemas que não conversam. Planilhas manuais, integrações frágeis e dados desatualizados gerando decisões erradas.",
    ...
    <section id="problema" className="section-padding relative">
      ...
      <Container className="relative">
        ...
        <div className="max-w-3xl mx-auto text-center section-header-gap">
          ...
          <h2 className="mb-5">
            <span className="text-foreground">Problemas que você</span>
            <span className="block text-muted-foreground mt-1">conhece bem demais.</span>
          </h2>
          
          <p className="body-text-lg mx-auto">
            Se você vende em múltiplos canais, já enfrentou isso. E sabe exatamente quanto custa em dinheiro, tempo e reputação.
          </p>
        </div>
