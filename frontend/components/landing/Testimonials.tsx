...
const concerns = [
  {
    ...
    description: "Vendas duplicadas em canais diferentes que geram reembolsos, frustração do cliente e dano à reputação da marca.",
    icon: "M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126zM12 15.75h.007v.008H12v-.008z",
  },
  {
    title: "Horas gastas em conferências manuais",
    description: "Equipes inteiras dedicadas a verificar estoque entre sistemas, atualizar planilhas e corrigir inconsistências diariamente.",
    icon: "M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z",
  },
  {
    title: "Clientes comprando produtos esgotados",
    description: "E-commerce mostrando disponibilidade enquanto o produto já foi vendido na loja física ou em outro canal.",
    icon: "M15.75 10.5V6a3.75 3.75 0 10-7.5 0v4.5m11.356-1.993l1.263 12c.07.665-.45 1.243-1.119 1.243H4.25a1.125 1.125 0 01-1.12-1.243l1.264-12A1.125 1.125 0 015.513 7.5h12.974c.576 0 1.059.435 1.119 1.007zM8.625 10.5a.375.375 0 11-.75 0 .375.375 0 01.75 0zm7.5 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z",
  },
  {
    title: "Dificuldade de escalar operação",
    description: "Adicionar novos canais de venda se torna um pesadelo operacional quando os sistemas não conversam entre si.",
