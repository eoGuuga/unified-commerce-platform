...
export function HeroSection() {
  return (
    <section className="bg-[#f7f9fc] text-slate-900">
      <div className="mx-auto w-full max-w-[1200px] px-6 pb-20 pt-10">
        <header className="flex flex-wrap items-center justify-between gap-6">
          ...
          <nav className="hidden items-center gap-6 text-sm text-slate-500 lg:flex" aria-label="Navegação">
            {menu.map((item) => (
          ...
          <div className="flex items-center gap-3 text-sm">
            <Link href="/login" className="text-slate-500 transition hover:text-slate-900 focus:outline-none focus:ring-2 focus:ring-slate-300">
              Entrar
            </Link>
            <Link
              href="#contato"
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <h1 className="text-4xl font-semibold leading-[1.05] text-slate-900 sm:text-5xl lg:text-6xl">
                Venda em todos os canais. <span className="text-blue-600">Sem conflitos.</span>
              </h1>
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <Link
                href="/login"
                className="rounded-xl border border-slate-200 px-5 py-3 text-sm font-semibold text-slate-600 transition hover:border-slate-300 hover:text-slate-900 focus:outline-none focus:ring-2 focus:ring-slate-200"
              >
                Entrar
              </Link>
            </div>

            <div className="flex flex-wrap items-center gap-5 border-t border-slate-200 pt-4 text-xs font-semibold text-slate-500">
