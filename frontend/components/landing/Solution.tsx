...
const features = [
  { text: "Sincronização rápida", icon: "M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z" },
  { text: "Transações ACID", icon: "M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25 2.25v6.75a2.25 2.25 0 002.25 2.25z" },
  { text: "Webhooks flexíveis", icon: "M13.19 8.688a4.5 4.5 0 011.242 7.244l-4.5 4.5a4.5 4.5 0 01-6.364-6.364l1.757-1.757m13.35-.622l1.757-1.757a4.5 4.5 0 00-6.364-6.364l-4.5 4.5a4.5 4.5 0 001.242 7.244" },
    ...
    <div className="relative w-44 h-44 lg:w-52 lg:h-52">
      ...
      <div className={`absolute inset-10 rounded-full border transition-all duration-700 flex items-center justify-center backdrop-blur-sm ${
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-xs font-semibold text-foreground uppercase tracking-[0.06em]">GTSoftHub</p>
        </div>
      </div>
    ...
    <section ref={sectionRef} id="solucao" className="section-padding relative">
      ...
      <Container className="relative">
        ...
        <div className="max-w-3xl mx-auto text-center section-header-gap">
          ...
          <h2 className="mb-5">
            <span className="text-foreground">Uma única fonte</span>
            <span className="block text-accent mt-1">da verdade.</span>
          </h2>
          
          <p className="body-text-lg mx-auto">
            Backend centralizado que garante consistência absoluta do estoque. 
            Todas as vendas passam por um único ponto de controle atômico.
          </p>
        </div>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="p-5 rounded-xl border border-border/40 bg-card/20">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-muted-foreground">Latência alvo</span>
