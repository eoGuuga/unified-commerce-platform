...
BOT: Oi! ðŸ‘‹ Bem-vindo Ã  ChocolÃ¡ Velha!
     Somos especializados em doces artesanais.
     
     Nossos principais produtos:
     ðŸ« 1. Brigadeiro Gourmet (R$ 10)
     ðŸ« 2. Trufa de Chocolate (R$ 12)
     ðŸ° 3. Bolo de Chocolate (R$ 25)
     ðŸ® 4. Mousse (R$ 8)
...
BOT: Ã“timo! 3 Brigadeiros Gourmet = R$ 30
     ...
     ðŸ’³ 1. CrÃ©dito/DÃ©bito
     ðŸ“± 2. Pix
     ðŸ’µ 3. Dinheiro (retirada)
...
5. Quando pedido fica pronto:
   ...
   â””â”€> Bot envia: "Seu pedido estÃ¡ pronto! ðŸŽ‰"
\`\`\`
...
\`\`\`
BOT: Desculpe, nÃ£o entendi muito bem. ðŸ˜…
...
\`\`\`
INVENTÃRIO - CHOCOLÃ VELHA
â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•

PRODUTO               ESTOQUE  MÃNIMO  STATUS   AÃ‡ÃƒO
...
ðŸŸ¢ PRONTOS (Aguardando retirada):
...
USUÃRIO    EMAIL              ROLE       STATUS    AÃ‡ÃƒO
