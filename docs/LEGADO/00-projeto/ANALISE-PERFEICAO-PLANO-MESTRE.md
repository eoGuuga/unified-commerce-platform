...
- `docs/LEGADO/15-servidor/SERVIDOR-HARDENED-ROOT.md` contem senha de sudo. Isso e uma falha critica. Deve ser removido e credenciais rotacionadas.
...
Testes declarados sem relatÃ³rios
...
- Auditoria inicial do servidor documentada em `docs/LEGADO/15-servidor/AUDITORIA-2026-01-12.md`.
...
- Checklist de deploy/rollback oficial em `docs/LEGADO/15-servidor/DEPLOY-ROLLBACK-CHECKLIST.md`.
...
3) Eu comeÃ§o a executar testes e gerar relatorios reais (backend + frontend).
