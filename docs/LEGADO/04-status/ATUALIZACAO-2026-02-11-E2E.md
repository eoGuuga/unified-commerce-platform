...
- Executar o plano E2E completo do arquivo docs/LEGADO/08-testes/PLANO-E2E-WHATSAPP-PDV-ESTOQUE.md.
...
## Proxima acao
- Criar/editar deploy/env.dev.example com ALLOW_TENANT_FROM_REQUEST=true e dados de dev.
...
- Token usado no PDV expirou apÃ³s restart do backend dev.
