...
**Branch:** `security/envelope-encryption-phase1` (3 commits: `384746c` feat, `f9b3912` chore deploy, `047135b` docs). **NÃO mergeada, NÃO pushada, NÃO deployada.** Aguarda a etapa dedicada de deploy.
